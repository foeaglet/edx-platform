...
class TestThirdPartyAuthUserStatusView(ThirdPartyAuthTestMixin, APITestCase):
    ...
    def test_get(self):
        ...
        assert response.status_code == 200
        assert response.data == [{'accepts_logins': True, 'name': 'Google', 'disconnect_url': '/auth/disconnect/google-oauth2/?', 'connect_url': '/auth/login/google-oauth2/?auth_entry=account_settings&next=%2Faccount%2Fsettings', 'connected': False, 'id': 'oa2-google-oauth2'}]
